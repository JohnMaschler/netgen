#!/bin/bash
#
#SBATCH --job-name=train_model_db
...
#SBATCH --output=train_model_db-%j.out  # Save output logs with job ID
#SBATCH --time=48:00:00
#SBATCH --mail-type=ALL           # Notify user of job events
#SBATCH --mail-user=apefourque@scu.edu  # Replace with your email
...
python train_model6_db_test.py
