...
class Encoder(nn.Module):
    """
    Transformer encoder that processes input tokens.
    Combines word embeddings with positional encodings before passing through transformer blocks.
    """
    def __init__(
        self,
        src_vocab_size,
...
class DecoderBlock(nn.Module):
    """
    Transformer decoder block with masked self-attention, cross-attention, and feed-forward networks.
...
class Decoder(nn.Module):
    """
    Transformer decoder that processes target tokens and encoder output.
    Generates output probabilities for the next token in the sequence.
    """
    def __init__(
        self,
        trg_vocab_size,
...
class Transformer(nn.Module):
    ...
    Handles creation of appropriate masks for source padding and target causality.
    """
    def __init__(
        self,
        src_vocab_size,
