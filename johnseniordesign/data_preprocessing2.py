...
def process_pcap(pcap_file_path, description, prompt, tags, output_json="streams1.json", max_packets=10000000):
...
if __name__ == "__main__":
    ...
    pcap_files = [
        ...
        {"path": os.path.join(data_dir, "pcaps2.pcap"), "description": "TCP packet data", "tags": "Normal,DNS"},
    ]
