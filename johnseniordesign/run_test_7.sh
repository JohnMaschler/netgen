#!/bin/bash
#
#SBATCH --job-name=train_model_db7
...
#SBATCH --output=train_model_db7-%j.out  # Save output logs with job ID
...
echo "Starting training model7..."
python train_model7_db_test.py
